        ...
        <Link href="/" passHref onClick={closeDrawer}>
          <div className="link-card inline-flex items-center gap-2 p-2">
            ...
            <div className="flex flex-col">
              <span className="font-semibold tracking-tight">AccessiBuddy</span>
              <span className="text-gray-600 dark:text-gray-400">Empowering your digital accessibility journey</span>
            </div>
          </div>
        </Link>
